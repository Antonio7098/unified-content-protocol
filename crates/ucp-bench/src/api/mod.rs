...
pub fn create_router(state: Arc<RwLock<AppState>>) -> Router {
    ...
    Router::new()
        ...
        .route("/api/registry/categories/:id/tests", get(handlers::get_category_tests))
        ...
        .route("/api/providers/available", get(handlers::get_available_providers))
        ...
        .route("/api/suites/:id", axum::routing::put(handlers::update_suite))
        ...
        .route("/api/runs/:id/results/:test_id", get(handlers::get_test_result))
        ...
        .route("/api/core/categories/:id/inputs", get(handlers::get_core_category_inputs))
        ...
        .route("/api/core/runs/:id/results/:test_id", get(handlers::get_core_test_result))
        ...
        .route("/api/playground/documents", get(handlers::list_playground_documents))
        .route("/api/playground/documents/:id", get(handlers::get_playground_document))
        .route("/api/playground/chat", axum::routing::post(handlers::playground_chat))
